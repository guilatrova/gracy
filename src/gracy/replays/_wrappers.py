...
from .storages._base import GracyReplayStorage

httpx_func_type = t.Callable[..., t.Awaitable[httpx.Response]]


def recordreplays_result(strategy: GracyReplayStorage, httpx_request_func: httpx_func_type):
...
def readreplays(strategy: GracyReplayStorage, client: httpx.AsyncClient, httpx_request_func: httpx_func_type):
    @wraps(httpx_request_func)
    async def _wrapper(*args: t.Any, **kwargs: t.Any):
